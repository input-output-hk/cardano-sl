...
import Daedalus.TLS as TLS

-- TLS

initTLS :: forall eff. EffFn1 (fs :: TLS.FS, err :: EXCEPTION | eff) String TLS.TLSOptions
initTLS = mkEffFn1 TLS.initTLS
--
-- getLocale :: forall eff. EffFn1 (ajax :: AJAX | eff) TLSOptions (Promise Json)
-- getLocale = mkEffFn1 \tls -> fromAff $ map encodeJson (getProfileLocale <$> B.getProfile tls)
--
-- updateLocale :: forall eff. EffFn2 (ajax :: AJAX | eff) TLSOptions String (Promise Json)
-- updateLocale = mkEffFn2 \tls locale -> fromAff <<< map encodeJson <<< B.updateProfile tls $ mkCProfile locale
--
-- getWallets :: forall eff. EffFn1 (ajax :: AJAX | eff) TLSOptions (Promise Json)
-- getWallets = mkEffFn1 $ fromAff <<< map encodeJson <<< B.getWallets
--
-- getWallet :: forall eff. EffFn2 (ajax :: AJAX | eff) TLSOptions String (Promise Json)
-- getWallet = mkEffFn2 \tls -> fromAff <<< map encodeJson <<< B.getWallet tls <<< mkCAddress
--
-- getHistory :: forall eff. EffFn4 (ajax :: AJAX | eff) TLSOptions String Int Int (Promise Json)
...
--         limit
--
-- searchHistory :: forall eff. EffFn5 (ajax :: AJAX | eff) TLSOptions String String Int Int (Promise Json)
...
--         limit
--
-- send :: forall eff. EffFn5 (ajax :: AJAX | eff) TLSOptions String String String String (Promise Json)
...
--         (mkCCoin amount)
--
-- sendExtended :: forall eff. EffFn8 (ajax :: AJAX | eff) TLSOptions String String String String String String String (Promise Json)
...
--
-- newWallet :: forall eff . EffFn6 (ajax :: AJAX, crypto :: Crypto.CRYPTO | eff) TLSOptions String String String String String
--   (Promise Json)
...
--
-- updateWallet :: forall eff. EffFn7 (ajax :: AJAX | eff) TLSOptions String String String String String Int (Promise Json)
...
--
-- updateTransaction :: forall eff. EffFn7 (ajax :: AJAX | eff) TLSOptions String String String String String Number (Promise Unit)
...
--
-- deleteWallet :: forall eff. EffFn2 (ajax :: AJAX | eff) TLSOptions String (Promise Unit)
-- deleteWallet = mkEffFn2 \tls -> fromAff <<< B.deleteWallet tls <<< mkCAddress
--
-- isValidAddress :: forall eff. EffFn3 (ajax :: AJAX | eff) TLSOptions String String (Promise Boolean)
...
-- notify = mkEffFn3 \messageCb errorCb -> do
...
--
-- blockchainSlotDuration :: forall eff. EffFn1 (ajax :: AJAX | eff) TLSOptions (Promise Int)
-- blockchainSlotDuration = mkEffFn1 $ fromAff <<< B.blockchainSlotDuration
--
-- restoreWallet :: forall eff. EffFn6 (ajax :: AJAX | eff) TLSOptions String String String String String (Promise Json)
...
--
-- restoreWalletIgnoreChecksum :: forall eff. EffFn6 (ajax :: AJAX | eff) TLSOptions String String String String String (Promise Json)
...
--
-- nextUpdate :: forall eff. EffFn1 (ajax :: AJAX | eff) TLSOptions (Promise Json)
-- nextUpdate = mkEffFn1 $ fromAff <<< map encodeJson <<< B.nextUpdate
--
-- applyUpdate :: forall eff. EffFn1 (ajax :: AJAX | eff) TLSOptions (Promise Unit)
-- applyUpdate = mkEffFn1 $ fromAff <<< B.applyUpdate
--
-- systemVersion :: forall eff. EffFn1 (ajax :: AJAX | eff) TLSOptions (Promise Json)
-- systemVersion = mkEffFn1 $ fromAff <<< map encodeJson <<< B.systemVersion
--
-- redeemAda :: forall eff. EffFn3 (ajax :: AJAX, crypto :: Crypto.CRYPTO | eff) TLSOptions String String (Promise Json)
-- redeemAda = mkEffFn3 \tls seed -> fromAff <<< map encodeJson <<< B.redeemAda tls <<< mkCWalletRedeem seed
--
-- redeemAdaPaperVend :: forall eff. EffFn4 (ajax :: AJAX, crypto :: Crypto.CRYPTO | eff) TLSOptions String String String (Promise Json)
...
--
-- reportInit :: forall eff. EffFn3 (ajax :: AJAX, crypto :: Crypto.CRYPTO | eff) TLSOptions Int Int (Promise Unit)
-- reportInit = mkEffFn3 \tls total -> fromAff <<< B.reportInit tls <<< mkCInitialized total
--
-- importKey :: forall eff. EffFn2 (ajax :: AJAX | eff) TLSOptions String (Promise Json)
-- importKey = mkEffFn2 \tls -> fromAff <<< map encodeJson <<< B.importKey tls
--
-- syncProgress :: forall eff. EffFn1 (ajax :: AJAX | eff) TLSOptions (Promise Json)
-- syncProgress = mkEffFn1 $ fromAff <<< map encodeJson <<< B.syncProgress
--
-- testReset :: forall eff. EffFn1 (ajax :: AJAX | eff) TLSOptions (Promise Unit)
