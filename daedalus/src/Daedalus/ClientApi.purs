...
import Daedalus.Types (mkCAddress, mkCoin, mkCWalletMeta, mkCTxId, mkCTxMeta, mkCCurrency, mkCProfile, mkCWalletInit, mkBackupPhrase, mkCWalletRedeem)
...
redeemADA = mkEffFn2 \seed -> fromAff <<< map encodeJson <<< either throwError B.redeemADA <<< mkCWalletRedeem seed
