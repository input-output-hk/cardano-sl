...
classifyNewHeaderObft
    ...
    => Genesis.Config -> BlockHeader -> m ClassifyHeaderRes
-- @intricate @mhuesch: Should a received genesis header be invalid in OBFT?
classifyNewHeaderObft _ (BlockHeaderGenesis _) = pure $ CHUseless "genesis header is useless"
