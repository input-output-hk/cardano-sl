...
Ouroboros requires a stake distribution to use as the basis of defining
the slot leader schedule for the next epoch.
...
See figure \ref{figrewards} below for the effect of various choices for
