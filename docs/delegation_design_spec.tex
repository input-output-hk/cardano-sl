...
stake key registration certificate for that key. See section
\ref{certificates-on-the-blockchain} for details on certificates on the
blockchain.
...
comparatively short, which is one of our requirements (recall section
\ref{short-addresses}). The pointer can be considerably shorter than
...
\begin{equation*}
\frac{
  \fun{txins} ~ \var{tx} \subseteq \var{utxo} \quad\quad
...
\begin{equation*}
\frac{
  \var{hk_{sk}} = \fun{hash} ~ \var{vk_{sk}} \quad\quad
  \var{hk_{sk}} \notin \var{stkeys} \quad\quad
...
\frac{
  \var{hk_{sk}} = \fun{hash} ~ \var{vk_{sk}} \quad\quad
  \var{hk_{sk}} \in \var{stkeys} \quad\quad
  \verified{\var{vk_{sk}}}{\var{vk_{sk}}}{\sigma}
}{
  \begin{array}{r}
...
\begin{equation*}
\frac{
  \var{cert} = (\var{vk_{sk}}, \var{hk_{sp}}) \quad\quad
  \var{hk_{sk}} = \fun{hash} ~ \var{vk_{sk}} \quad\quad
  \var{hk_{sk}} \in \var{stkeys} \quad\quad
...
\frac{
  \begin{array}{c}
    \var{cert} = (\var{vk_{sp}}, \var{pledge}, (c, m), \var{alt}) \quad\quad
    \var{hk_{sp}} = \fun{hash} ~ \var{vk_{sp}}
    \\[0.3em]
    \verified{\var{vk_{sp}}}{\var{cert}}{\sigma} \quad\quad 
    \forall \var{vk_{sk}} \in \var{pledge}. ~ \exists \sigma \in \Sigma. ~
      \verified{\var{vk_{sk}}}{\var{cert}}{\sigma}  \quad\quad
...
\frac{
  \begin{array}{c}
    \var{cert} = (\var{vk_{sp}}, e) \quad\quad
    \var{hk_{sp}} = \fun{hash} ~ \var{vk_{sp}}
    \\[0.3em]
    \var{hk_{sp}} \in \dom \var{stpools} \quad\quad
    \var{epoch} < e < \var{epoch} + E_\var{max} \quad\quad
