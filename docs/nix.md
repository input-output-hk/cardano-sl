...
the arch like this:
    ...
    nix-build release.nix -A cardano-sl-wallet.x86_64-linux
...
To build any branch straight from a GitHub tarball:
    ...
    nix-build https://github.com/input-output-hk/cardano-sl/archive/develop.tar.gz -A cardano-sl-wallet
