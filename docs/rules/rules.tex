...
\item[seed computation] The list of seed computation messages is set
  to be the entire seed mempool (see
...
\item[seed mempool] a list of seed computation messages, all of the
  same type (either commitments, openings, or recovery)
\end{description}
