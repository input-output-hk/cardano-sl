...
\item[Transactions] Each transaction in the block's transactions is
  ...
  \item[Stateful] Stateful transaction validation rules are
    ...
    \item[Conservation of value] The total amount of inputs must equal
      the total amount of outputs.\critical{This ignores the minimal
        transaction fee, but given that it depends ont the size of the
        binary encoding of a transaction, I don't know yet how to fix
        this.}
