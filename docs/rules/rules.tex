...
\item Block validation has an extra condition
  ...
  \item[Pool certificate] \improvement{TODO: validation rules for pool
      ...
      id.}
  \end{description}
\item The issuer condition of block validation is changes as follows
  \begin{description}
  \item[Issuer] The issuer of $b$ must be the slot leader at the slot
    of $b$ (defined as in the current rule).
  \end{description}
...
\item A pooling state is defined as a function
  ...
  \end{implementationhint}
\end{itemize}
\improvement{TODO: limit the depth of delegation}

\unsure{The richmen formula may need to be changed to remove the
  delegation graph.}
