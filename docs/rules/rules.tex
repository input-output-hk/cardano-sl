...
\item[Block] Blocks have a system of identifier $\blockids$. There is
  ...
  \item[seed computation] Any of the following
    ...
    \item[Recovery] A finite-domain partial function
      ...
      \begin{implementationhint}
        We want to understand $r(a)(a')$ as the decrypted share of agent $a$
        from the secret seed of agent $a'$. So $r(a)$ is the set of
        all the shares that $a$ decrypted.
...
%  LocalWords:  stateful decrypted monoid
