...
\item[Issuer] The issuer of $b$ is the slot leader at the block's slot
  ...
  \improvement{This ignores delegation}
...
\item[Seed] \info{The shared seed at the last epoch} Define $\epochseed{⋅}$\improvement{Todo}
\end{description}
...
necessarily being unique at that length).
