...
import           Pos.Explorer.Socket.Holder (ConnectionsState, ExplorerSocket (..),
                     csAddressSubscribers, csBlocksPageSubscribers, csClients,
                     csEpochsLastPageSubscribers, csTxsSubscribers, mkClientContext,
                     mkConnectionsState)
import           Pos.Explorer.Socket.Methods (addrSubParam, addressSetByTxs, blockPageSubParam,
                     fromCAddressOrThrow, spSessId, subscribeAddr, subscribeBlocksLastPage,
                     subscribeEpochsLastPage, subscribeTxs, txsSubParam, unsubscribeAddr,
                     unsubscribeBlocksLastPage, unsubscribeEpochsLastPage, unsubscribeFully,
                     unsubscribeTxs)
