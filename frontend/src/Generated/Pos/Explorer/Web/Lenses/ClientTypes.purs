...
cbeBlockLead :: forall a b r. Lens.Lens { "cbeBlockLead" :: a | r } { "cbeBlockLead" :: b | r } a b
cbeBlockLead = Lens.lens _."cbeBlockLead" (_ { "cbeBlockLead" = _ })
...
ctbInputSum :: forall a b r. Lens.Lens { "ctbInputSum" :: a | r } { "ctbInputSum" :: b | r } a b
ctbInputSum = Lens.lens _."ctbInputSum" (_ { "ctbInputSum" = _ })

ctbOutputSum :: forall a b r. Lens.Lens { "ctbOutputSum" :: a | r } { "ctbOutputSum" :: b | r } a b
ctbOutputSum = Lens.lens _."ctbOutputSum" (_ { "ctbOutputSum" = _ })
...
_CCoin :: Lens.Iso' CCoin
            { "getCoin" :: String
            }
_CCoin = Lens.iso unwrap CCoin
  where
    unwrap (CCoin x) = x
