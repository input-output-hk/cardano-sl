...
--   * there is no existing certificate with the same VSS key
--   * the map doesn't contain certificates with the same VSS key (this
--      check is useless for certificate maps obtained through
