...
findDelegationStakes
    ...
    -> Coin
    -> Sink (StakeholderId, [StakeholderId]) m (RichmenSet, RichmenStake)
findDelegationStakes _isIssuer _stakeResolver _t = undefined
...
findRichmenStake t = undefined -- step mempty
--  where
