...
and to the newer version `Ouroboros genesis' \citep{ouroboros-genesis}. We will
...
\item In both Ouroboros Classic and Genesis it is possible for adversarial
      players to sign multiple blocks for the same slot, but this is visible
      (so-called `open adversarial behaviour').
