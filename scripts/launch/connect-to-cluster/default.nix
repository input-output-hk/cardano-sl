...
, cardano-sl-wallet-static, cardano-sl-explorer-static, cardano-sl-tools-static
, cardano-sl-config
...
let
  ...
  executables =  {
    wallet = if useStackBinaries then "stack exec -- cardano-node" else "${cardano-sl-wallet-static}/bin/cardano-node";
