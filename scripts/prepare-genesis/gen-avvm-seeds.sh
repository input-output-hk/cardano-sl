...
pushd "$REPO_PATH"
stack exec --nix -- cardano-keygen --configuration-file node/configuration.yaml --configuration-key mainnet_launch_base generate-avvm-seeds -n "$AVVM_SEED_COUNT" -o keys/avvm
popd
