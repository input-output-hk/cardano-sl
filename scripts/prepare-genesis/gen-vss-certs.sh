...
for i in $ALL_NODES; do
    stack exec --nix -- cardano-keygen --configuration-file node/configuration.mainnet.yaml --configuration-key mainnet_dryrun_base generate-vss --path "${DELEGATE}${i}.key"
done
popd
