...
#
# To get a repl for cardano-sl-wallet with stack:
#
#     nix-shell
#     stack ghci cardano-sl-wallet
#
# To get a repl for cardano-sl-wallet with cabal:
#
#     nix-shell
#     cabal new-repl cardano-sl-wallet
#
