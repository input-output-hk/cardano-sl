...
data NodeContext ssc = NodeContext
    ...
    -- ^ Header of last known block, generated by network
    -- (announcement of which reached us). Should be use only for
    -- informational purposes (status in Daedalus). It's easy to falsify this value.
    }
