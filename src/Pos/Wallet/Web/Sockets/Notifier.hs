...
import           Pos.Communication                 (OutSpecs, SendActions (..),
...
import           Pos.Wallet.Web.Sockets.Connection (closeWSConnections,
                                                    getWalletWebSockets,
                                                    initWSConnections, notifyAll,
