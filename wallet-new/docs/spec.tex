...
just querying the wallet balance, updating as new blocks arrive, and adding
...
initial basic spec, we extend the spec to cover tracking of metadata in
...
significant topic in its own right as it is a non-trivial problem for UTxO
based currencies. The wallet design means that input selection can be handled
