...
import           Pos.Crypto.Signing (PublicKey, EncryptedSecretKey,
                                     encToPublic, encodeBase58PublicKey, noPassEncrypt)
...
makeGenesisWallet :: WalletClient IO -> IO Wallet
makeGenesisWallet wc = do
