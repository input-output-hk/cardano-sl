...
toTransaction :: Catch.MonadThrow m  => V0.CTx -> m Transaction
...
fromAssuranceLevel :: Catch.MonadThrow m  => V1.AssuranceLevel -> m V0.CWalletAssurance
...
toNewWallet :: Catch.MonadThrow m  => (V0.CWallet, V0.WalletInfo, V1.WalletType, Maybe Core.ChainDifficulty) -> m V1.Wallet
