...
-- in "Cardano.Wallet.Compatibility.State.Storage".
module Cardano.Wallet.Compatibility.State.Acidic
       (
         WalletDB
       , closeState
       , openMemState
...
import           Cardano.Wallet.Compatibility.State.Storage (WalletStorage)
import           Cardano.Wallet.Compatibility.State.Storage as WS
import           Cardano.Wallet.Compatibility.State.Transactions as WST
