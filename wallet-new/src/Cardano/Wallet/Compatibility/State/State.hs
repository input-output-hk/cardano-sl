...
module Cardano.Wallet.Compatibility.State.State
       ( WalletDB
       , WalletDbReader
       , WalletSyncState (..)
...
import           Cardano.Wallet.Compatibility.ClientTypes (AccountId,
                     CAccountMeta, CId, CProfile, CTxId, CTxMeta, CUpdateInfo,
                     CWalletMeta, PassPhraseLU, Wal)
import           Cardano.Wallet.Compatibility.Pending.Types (PendingTx (..),
                     PtxCondition)
import           Cardano.Wallet.Compatibility.State.Acidic (WalletDB,
                     closeState, openMemState, openState)
import           Cardano.Wallet.Compatibility.State.Acidic as A
import           Cardano.Wallet.Compatibility.State.Storage (AddressInfo (..),
...
import qualified Cardano.Wallet.Compatibility.State.Storage as S
import           Data.Acid (EventResult, EventState, QueryEvent, UpdateEvent)
import qualified Data.Map as Map
import           Pos.Chain.Block (HeaderHash)
import           Pos.Chain.Txp (TxId, Utxo, UtxoModifier)
import           Pos.Client.Txp.History (TxHistoryEntry)
import           Pos.Core (Address, ChainDifficulty, ProtocolConstants, SlotId)
