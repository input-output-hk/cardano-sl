...
module Cardano.Wallet.Compatibility.State.Storage
       (
         WalletStorage (..)
       , HasWalletStorage (..)
       , WAddressMeta (..)
...
import           Cardano.Wallet.Compatibility.Pending.Types (PendingTx (..),
                     PtxCondition, PtxSubmitTiming (..), ptxCond,
                     ptxSubmitTiming, _PtxCreating)
import           Cardano.Wallet.Compatibility.Pending.Util (cancelApplyingPtx,
