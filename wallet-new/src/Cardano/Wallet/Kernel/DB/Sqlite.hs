...
import           Database.Beam.Backend.SQL (FromBackendRow,
                     HasSqlValueSyntax (..), intType, IsSql92DataTypeSyntax,
                     valueE, varCharType)
    ...
    where
        ...
        handleResponse e =
            ...
            in case e of
                ...
                (Sqlite.SQLConstraintError Sqlite.Unique "tx_metas_inputs.input_foreign_id, tx_metas_inputs.input_foreign_index") -> do
