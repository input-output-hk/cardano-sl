...
servantHandlersWithSwagger pm pc ntpStatus submitTx nat =
    hoistServer A.walletApi nat (servantHandlers pm pc ntpStatus submitTx)
   :<|>
...
servantHandlers pm pc ntpStatus submitTx = toServant' A.WalletApiRecord
    { _test        = testHandlers
